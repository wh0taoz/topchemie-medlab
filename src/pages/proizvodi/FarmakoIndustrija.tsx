        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="backdrop-blur-md bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
              <h2 className="text-4xl font-light mb-6 tracking-tight">Potrebne Vam Farmaceutske Sirovine?</h2>
              <p className="text-xl mb-8 text-white/90 font-light">
                Za detaljne informacije o našim farmaceutskim proizvodima i uslugama,
